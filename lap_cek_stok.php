    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="row">
          <div class="col-md-6">
            <!-- Judul Halaman -->
            <h4>Laporan Pengecekan Stok Barang</h4>
          </div>
          <div class="col-md-6 text-right">
            <?php if ($kategori) : ?>
              <a href="" class="btn btn-warning">REFRESH</a>
            <?php endif; ?>
            <a href="laporan/cetak_cek_stok.php?kategori=<?= $kategori ?>" class="btn btn-primary" target="_blank">PRINT</a>
          </div>
        </div>
      </div>
      <!-- /.card-header -->
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td class="text-center"><?= $data['stok_fisik'] ?> <?= $data['satuan'] ?></td>
